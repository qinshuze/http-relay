...
const AppClient_1 = __importDefault(require("../../rpc/AppClient"));
...
class HttpRelay {
    ...
    fileDownload(req, res, options) {
        ...
        if (appid) {
            ...
            // 获取文件信息
            const cid = (0, crypto_1.randomUUID)().toString();
            const appClient = new AppClient_1.default(appid, this.webSocketClient);
            appClient.getFileInfo(filepath, this.filterParams(params)).then((result) => {
                ...
                // 通知指定客户端已做好接收文件的准备
                let rangeStart = ((_a = headerRange.ranges[0]) === null || _a === void 0 ? void 0 : _a.start) || 0;
                let rangeEnd = ((_b = headerRange.ranges[0]) === null || _b === void 0 ? void 0 : _b.end) || fileInfo.size;
    ...
    getHeaderRange(req) {
        ...
        const ranges = [];
        for (const item of ((_a = rangesStr === null || rangesStr === void 0 ? void 0 : rangesStr.replace(/\s+/g, "")) === null || _a === void 0 ? void 0 : _a.split(",")) || []) {
     ...
     * @private
     */
    fileRelay(req, res, cid, targetReq, targetRes) {
        var _a, _b, _c;
        ...
        if (!fileInfo) {
            logger_1.default.error(`${req.url} fileInfo 信息丢失`);
        ...
        const rangeStart = ((_a = ranges[0]) === null || _a === void 0 ? void 0 : _a.start) || 0;
        const rangeEnd = ((_b = ranges[0]) === null || _b === void 0 ? void 0 : _b.end) || (fileInfo.size - 1);
        if (ranges.length) {
        ...
        req.on("data", data => {
            ...
            if (newTargetRes.writableEnded || newTargetRes.closed)
                return;
        ...
        (_c = clientRequest.init) === null || _c === void 0 ? void 0 : _c.call(clientRequest, req, res);
    }
    /**
     * 获取etag
     * @param fileInfo
     ...
     * @private
     */
    sendResponse(res, code = 200, statusMsg = "", content = "") {
        var _a;
        if (res.writableEnded || ((_a = res.socket) === null || _a === void 0 ? void 0 : _a.destroyed) || res.closed)
            return;
        res.statusCode = code;
...
HttpRelay.clientRequestMap = new Map();
exports.default = HttpRelay;
